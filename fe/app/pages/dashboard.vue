  ...
  <div class="p-6 space-y-6">
    ...
    <Card>
      ...
      <CardContent class="px-4 pb-2">
        <p v-if="recentApplications.length === 0" class="py-6 text-center text-sm text-muted-foreground">
          No applications yet. Add your first one.
        </p>
        <NuxtLink v-for="app in recentApplications" :key="app.id" to="/applications"
