...
import { PhEnvelope, PhLock, PhGoogleLogo } from '@phosphor-icons/vue'
    ...
    <main class="form-panel">
      <div class="form-body">
        <div class="form-head">
          ...
          <p class="form-sub">Sign in to continue to ApplyPilot</p>
        </div>
        ...
        <p class="switch-prompt">
          ...
          <NuxtLink to="/register" class="switch-link">Sign up</NuxtLink>
        </p>
      </div>
    </main>
  </div>
